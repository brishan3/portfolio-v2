      ...
      <div className="mx-auto max-w-5xl space-y-12 px-6">
        <div className="relative z-10 grid items-center gap-4 md:grid-cols-2 md:gap-12">
          ...
          <p className="max-w-sm sm:ml-auto">
            A collection of full-stack web applications showcasing modern technologies, from AI-powered SaaS platforms to e-commerce solutions and content management systems.
          </p>
        </div>
