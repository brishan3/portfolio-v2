        ...
        <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-12">
          <ScrollView>
            <h2 className="text-4xl font-medium lg:text-5xl">
              Built with passion, trusted by clients
            </h2>
          </ScrollView>
          <ScrollView delay={0.2}>
            <p>
              My work spans from AI-powered applications to e-commerce platforms, helping businesses innovate and grow through modern web technologies and thoughtful user experiences.
            </p>
          </ScrollView>
        </div>
